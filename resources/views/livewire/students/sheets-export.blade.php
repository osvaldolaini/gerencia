<div>
    <div class="p-0 tooltip tooltip-top" data-tip="Baixar modelo">
        <button class="btn btn-outline btn-accent" wire:click="downloadExcel()"
            class="flex items-center justify-center px-3 py-1 text-sm tracking-wide text-blue-500 transition-colors duration-200 rounded-lg sm:w-auto ">
