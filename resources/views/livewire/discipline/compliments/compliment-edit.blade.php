<div>
    ...
    <div class="py-4 rounded-2xl dark:bg-gray-700 ">
        ...
        <div class="flex justify-between mx-2 space-x-2 text-gray-600 lg:mx-1">
            ...
            <div>
                @livewire('discipline.compliments.compliment-link', [$id])
            </div>
        </div>
    </div>
    <form>
        <x-layout.tabs>
            ...
            <x-slot name="content">
                ...
                <div id="tab5" x-show="activeTab === '#tab3'">
                    <div class="grid grid-cols-2 gap-2 mb-1 sm:grid-cols-6 sm:gap-3 sm:mb-5">
                            ...
                            @foreach (ComplimentType::cases() as $item)
                                <div class="p-0 tooltip tooltip-top" data-tip="{{ $item->label() }}">
                                    <label
                                        ...
                                        <input type="radio" wire:model.live="compliment_type"
                                            value="{{ $item->value }}" class="hidden peer"
                                            {{ $item->value == $compliment_type ? 'checked' : '' }}>
                        ...
                        <div class="col-span-full sm:col-span-full ">
                            <label class="block text-sm font-medium text-gray-900 dark:text-white" for="title">
                                Texto <span wire:click="sugestionText()" class="mb-1 cursor-pointer badge badge-info">
                                    Sugestão de solução
                            ...
                            <textarea wire:model="solution" rows="5"
                ...
                <div id="tab6" x-show="activeTab === '#tab5'">
                    <div class="grid grid-cols-2 gap-2 mb-1 sm:grid-cols-6 sm:gap-3 sm:mb-5">
                        <div class="col-span-full sm:col-span-1">
                            <label class="block text-sm font-medium text-gray-900 dark:text-white" for="title">
                                Nota p/Bol Nr</label>
