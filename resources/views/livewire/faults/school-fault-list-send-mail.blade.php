<div>
    ...
    <div class="grid grid-cols-1 gap-3 mt-5 mb-5 md:grid-cols-2">
        ...
        <div>
            ...
            <input type="text" wire:model.live="search" placeholder="Nome do aluno ou nº"
        ...
        <div>
            ...
            <select wire:model.live="sortStudents"
                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg
                       focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5
                       dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400
                       dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
                <option value="percent_desc">
                    Maior percentual de faltas
                </option>

                <option value="percent_asc">
                    Menor percentual de faltas
                </option>
    ...
    <div class="mt-5 space-y-4" wire:model='students'>
                        ...
                        <div type="button"
                            ...
                            <div class="grid grid-cols-8 gap-2 mx-2 ">
                                ...
                                <div class="col-span-full sm:col-span-2">
                                    ...
                                    <div class="max-w-xs">
                                        <p>
                                            nº. {{ $item->num ?? $item?->oldSudents?->num }}
                                        </p>
                                        <p>
