    ...
    <div class="grid w-full grid-cols-6 gap-2">
        <span class="col-span-full sm:col-span-2">
            <div class="relative h-32 overflow-hidden bg-blue-500 rounded-lg shadow-md">
                @if ($config->id)
                    <picture class="absolute w-24 h-24 text-red-800 rounded-md opacity-50 top-2 -right-6 md:-right-4">
                        <source srcset="{{ url('storage/logos-school/logo.png') }}" />
                        <source srcset="{{ url('storage/logos-school/logo.webp') }}" />
                        <img class="absolute w-24 h-24 text-red-800 rounded-md opacity-50 top-2 -right-6 md:-right-4"
                            src="{{ url('storage/logos-school/logo.png') }}" alt="api-gerencia">
                    </picture>
                @else
                    <svg class="absolute w-24 h-24 text-red-800 rounded-md opacity-50 top-2 -right-6 md:-right-4"
                                ...
                                <div class="relative h-32 overflow-hidden bg-red-500 rounded-lg shadow-md">
                                    @if ($grade->code_image)
                                        <picture>
                                            ...
                                            <img class="absolute w-24 h-24 text-red-800 rounded-md opacity-50 top-2 -right-6 md:-right-4 src="{{ url('storage/companies/' . $grade->id . '/' . $grade->code_image . '_list.png') }}"
                                                alt="{{ $grade->name }}">
                                        </picture>
                                    @else
                                        <svg class="absolute w-24 h-24 text-red-800 rounded-md opacity-50 top-2 -right-6 md:-right-4"
