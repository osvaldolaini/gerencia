                            ...
                            <div class="col-span-full ">
                                ...
                                @if ($student)
                                    <div role="alert" class="w-full col-span-2 shadow-xl alert ">
                                        <figure>
                                            <img src="{{ url('storage/student/' . $student['id'] . '/' . $student['code_image'] . '_list.png') }}"
                                                class="mx-auto rounded ">
                                        </figure>
                                        <div>
                                            <h3 class="font-bold">Al. {{ $student['nick'] }}</h3>
                                            <div class="text-xs">T. {{ $student['class'] }}</div>
                                        </div>
                                        <span wire:click="removeStudents()"
                                            class="btn btn-sm {{ $student['sex'] == 'F' ? 'btn-secondary' : 'btn-info' }}">Excluir
