                                ...
                                <div class="relative h-32 overflow-hidden bg-blue-500 rounded-lg shadow-md">
                                    @if ($grade->code_image)
                                        <picture>
                                            ...
                                            <img class="absolute w-24 h-24 text-blue-800 rounded-md opacity-50 -top-6 -right-6 md:-right-4 src="{{ url('storage/companies/' . $grade->id . '/' . $grade->code_image . '_list.png') }}"
                                                alt="{{ $grade->name }}">
                                        </picture>
                                    @else
                                        <svg class="absolute w-24 h-24 text-blue-800 rounded-md opacity-50 -top-6 -right-6 md:-right-4"
