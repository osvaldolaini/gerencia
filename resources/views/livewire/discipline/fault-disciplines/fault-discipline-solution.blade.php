<div>
    <div class="flex items-center justify-center w-full mb-5 space-x-1">
        ...
        @if ($paste)
            ...
            <a class="btn btn-outline" download
                href="{{ url('storage/fafd/' . $fault_discipline->id . '/fafd_n_solucao_' . $fault_discipline->number . '.pdf') }}">
    ...
    <div class="w-full">
        <div>
            @if ($paste)
                <object
                    data="{{ url('storage/fafd/' . $fault_discipline->id . '/fafd_n_solucao_' . $fault_discipline->number . '.pdf') }}"
