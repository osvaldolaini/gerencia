<div x-data="{ openDropdown: null }" :class="{ 'block': open, 'hidden': !open }"
    ...
    <div class="relative flex flex-col justify-between w-64 h-screen bg-white dark:bg-gray-800">
        <nav class="mt-5 space-y-1">
            <x-layout.side-bar-nav-link url="dashboard" active="*dashboard*" access_page="dashboard">
                <x-slot name="svg">
            ...
            {{-- DISCIPLINA --}}
            <x-layout.side-bar-nav-link url="my-fact-observed" active="*fato-observado*" access_page="fact_observed">
                <x-slot name="svg">
            ...
            {{-- Faltas --}}
            <x-layout.side-bar-nav-link url="my-insert-faults" active="*faltas-lancadas*"
