                                            ...
                                            <x-slot name="extra">
                                                ...
                                                <div class="p-0 tooltip tooltip-top" data-tip="Ver Texto">
                                                    ...
                                                    @livewire(
                                                        ...
                                                        [
                                                            'model' => App\Models\Discipline\FactObserved::class,
                                                            'itemId' => $item->id,
                                                        ],
                                                        key('fault-observed-' . $item->id)
                                                    )
                                                </div>
                                            </x-slot>
                                    ...
                                    @if (!$item->fafd_id && !$item->compliment_id)
                                        ...
                                        @if (!$item->sincomil_date)
                                            @if ($item->fact_type == 'positivo')
                                                <div class="mt-2 btn btn-outline btn-success">
                                            ...
                                            @if ($item->fact_type == 'negativo')
                                                <div class="mt-2 btn btn-outline btn-error">
                                                    <label class="inline-flex items-center cursor-pointer">
            ...
            @if (count($selectedList) > 0)
                ...
                <div class="space-y-2">
                    ...
                    @foreach ($selectedList as $student)
                        <div class="flex items-center gap-3 p-1 bg-gray-100 rounded-lg dark:bg-gray-800">
