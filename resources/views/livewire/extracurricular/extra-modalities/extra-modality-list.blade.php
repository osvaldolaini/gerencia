<div>
    ...
    <x-dialog-modal wire:model="showModalForm" maxWidth="4xl">
        ...
        <x-slot name="content">
            @if ($extra_modality)
                @livewire('extracurricular.extra-modalities.extra-modality-form', ['extra_modality' => $extra_modality], key($extra_modality->id))
            @else
                @livewire('extracurricular.extra-modalities.extra-modality-form')
            @endif
        </x-slot>
        <x-slot name="footer">
