<div>
    @if ($print_battalion)
        <div class="p-0 tooltip tooltip-top" data-tip="Batalhão" wire:ignore>
            <a href="{{ route('school-battalion-view') }}"
    ...
    @endif
    @if ($print_classes_sex)
        <div class="p-0 tooltip tooltip-top" data-tip="Formatura" wire:ignore>
    ...
    @endif
    @if ($print_grau)
        <div class="p-0 tooltip tooltip-top" data-tip="Comportamento" wire:ignore>
            <button wire:click="grau()"
                class="px-3 py-2 transition-colors duration-200 rounded-sm hover:text-white dark:hover:bg-blue-500 hover:bg-blue-500 whitespace-nowrap">
                <x-layout.svg.pdf class="w-6 h-6"></x-layout.svg.pdf>
            </button>
        </div>
    @endif
    @if ($print_grau_plan)
        <div class="p-0 tooltip tooltip-top" data-tip="Comportamento planilha" wire:ignore>
            <button wire:click="grau_plan()"
                class="px-3 py-2 transition-colors duration-200 rounded-sm hover:text-white dark:hover:bg-blue-500 hover:bg-blue-500 whitespace-nowrap">
