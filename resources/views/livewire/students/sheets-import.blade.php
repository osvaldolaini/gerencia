<div>
    <div class="flex justify-start p-0 tooltip tooltip-top" data-tip="Importar lista de alunos">
        <button class="btn btn-outline btn-accent" wire:click="showModal()"
            ...
            <svg class="w-6 h-6 " fill="currentColor" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
                xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 512 512" xml:space="preserve">
                <g>
                    <g>
                        <path d="M424.166,352.367l-34.133-34.133c-3.336-3.336-8.73-3.336-12.066,0l-34.133,34.133c-3.337,3.337-3.337,8.73,0,12.066
        ...
        <div wire:model='import' class="{{ $import ? 'flex' : 'hidden' }}">
            <form action="#" wire:submit.prevent="importExcel()" wire.loading.attr='disable'>
                <div
                    class="flex flex-col items-stretch w-full p-2 space-y-2 md:w-auto md:flex-row md:space-y-0 md:items-center md:space-x-3">
                    <section class="w-full px-6 pt-5 pb-2 dark:bg-gray-800 dark:text-gray-50">

                        <div class="grid grid-cols-2 gap-4 mb-1 sm:gap-6 sm:mb-5">
                            <div class="col-span-2">
                                <div class="col-span-2" x-data="{ isUploading: false, progress: 0 }"
                                    ...
                                    <!-- File Input -->
                                    <input type="file" wire:model="sheet" id="sheet"
                    ...
                    <div class="flex group ">
                        <button type="submit"
                            class="flex-col items-center justify-center w-1/2 px-5 py-2 text-sm tracking-wide text-center text-white transition-colors duration-200 bg-blue-500 rounded-lg sm:w-auto gap-x-2 hover:bg-blue-600 dark:hover:bg-blue-500 dark:bg-blue-600">
                            <svg class="w-10 h-10 mx-auto" fill="currentColor" version="1.1" id="Layer_1"
                            ...
                            <span>Importar novos alunos </span>
                        </button>
