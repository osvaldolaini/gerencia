...
<body>
                ...
                @else
                    ...
                    @else
                        <p>3. Por fim, no uso de minhas atribuições de Comandante de Companhia, deixo de aplicar medida
                            ...
                            das
                            Normas Reguladoras do Regime Disciplinar (NRDD), do Regimento Interno dos Colégios Militares
                            (RICM 2024), “A 1ª falta do aluno passível de medida mínima de retirada do CM é da
                            competência
                            do Cmt CM”.</p>
                    @endif
    ...
    @else
        @if ($fault_discipline->decision == 'retirada_cm')
            @if ($fault_discipline->dacision_days <= 3)
                {{-- COMANDANTE DO CA --}}
                <div class="break-page"></div>
                <div class="container">
                    <div class="header">
                        ...
                        <div style="padding: 5px 5px;">
                            <p>1. Após análise do fato descrito no FAFD Nr
                                {{ $fault_discipline->number }}/{{ $fault_discipline->year }}
                                de {{ $fault_discipline->f_date }},e considerar as alegações prestadas nas
                                justificativas
                                apresentadas por escrito e ouvir o(a) Al {{ $fault_discipline->al_number }}
                                {{ $fault_discipline->al_nick }},
                                concluo que o fato ocorreu da seguinte forma:
                ...
                <div class="container">
                    <div class="header">
                        ...
                        <div style="padding: 5px 5px;">
                            ...
                            <p>{{ $fault_discipline->fact }}</p>
                            <p>2. {{ $fault_discipline->solution }}</p>
                            <p>3. Por fim, no uso de minhas atribuições de Comandante do Corpo de Alunos, deixo de
                                aplicar
                                medida disciplinar de Retirada ao aluno, em cumprimento ao número 29, da letra c, do nº
                                5,
                                Anexo
                                F, das Normas Reguladoras do Regime Disciplinar (NRDD), do Regimento Interno dos
                                Colégios
                                Militares (RICM 2024), “A 1ª falta do aluno passível de medida mínima de retirada do CM
                                é da
                                competência do Cmt CM”.</p>
                ...
                <div class="container">
                    <div class="header">
                        ...
                        <div style="padding: 5px 5px;">
                            ...
                            <p>2. {{ $fault_discipline->solution }}</p>
                            <p>
                                3. Por fim, no uso de minhas atribuições de Comandante do {{ $config->nick }} decido
                                punir
                                o(a)
                                aluno(a)
                                com {{ $fault_discipline->dacision_days }} dia
