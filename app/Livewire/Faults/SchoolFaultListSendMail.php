            ...
            foreach ($this->contacts->where('active', 1) as $contact) {
                ...
                if ($contact->type == 'email') {
                    ...
                    if (filter_var($contact->contact, FILTER_VALIDATE_EMAIL)) {
                        try {
                            Mail::send(
                                new \App\Mail\StudentAlertFaults([
                                    'contact'    => $contact,
                            ...
                            Emails::create([
                                ...
                                'to'                   => $contact->contact,
                                'subject'              => 'Aviso de ' . $this->percent . ' de faltas',
                                'message'              => 'Encaminho',
                                'attachment'           => $this->downloadTmp(),
                                'code'                 => Str::uuid(),
                            ]);
            ...
            if ($countMail > 0) {
                ...
                if ($user?->people) {
                    ...
                    FactObserved::create([
                        ...
                        'al_number'                => $al_number,
                        'al_class'                 => $al_class,
                        'fact'                     => 'Foi enviado a aviso de ' . $this->percent . ' de faltas do aluno para os responsáveis.',
