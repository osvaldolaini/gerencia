<div class="w-full py-5 text-gray-500 dark:text-gray-100">
    <small
        class="flex justify-center w-full mb-5 ml-2 space-x-1 text-5xl font-extrabold text-center text-gray-500 dark:text-gray-100">
            ...
            <div class="col-span-4 sm:col-span-1 ">
                <table class="flex justify-center mx-10 mb-10 rounded-md ">
                    ...
                    @php
                        $c = 0;
                    @endphp
                    @foreach ($value->studentsPivot->where('active', 1)->sortBy('students.nick') as $pivot)
                        @php
                            $c += 1;
                        @endphp
