        ...
        <div class="header" style="border: none;">
            ...
            <div style="margin-bottom: 10px;margin-top:10px;">
                <svg viewBox="0 0 600 600" version="1.1" id="svg9724" sodipodi:docname="cut.svg"
                    inkscape:version="1.2.2 (1:1.2.2+202212051550+b0a8486541)" width="30" height="30"
            ...
            <table class="identification" style="margin-top: 80px;">
                <div class="font-weight: bold;font-size:20pt;">
                    {{ $fault_discipline->number }}/{{ $fault_discipline->year }}</div>
                @if ($selectedFaults)
                    <tr>
                        <td colspan="4" Style="font-weight: bold;text-align:center;border-top: 1px solid black;">
                            Enquadramento
