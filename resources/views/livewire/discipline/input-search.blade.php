<div x-init>
    <fieldset class="w-full col-span-1 space-y-1 dark:text-gray-100" wire:click="openModalSearch()" wire:ignore>
        <label for="Search" class="hidden">Pesquisar alunos</label>
    ...
    <x-dialog-modal wire:model="modalSearch" class="mt-0">
        <x-slot name="title">Pesquisar Alunos</x-slot>
        <x-slot name="content">
                                                ...
                                                <div class="flex items-center gap-3 cursor-pointer "
                                                    ...
                                                    <div class="avatar">
                                                        <div class="h-24 w-18">
                                                            @if ($item->code_image)
                                                                <div class="avatar">
                                                                    <div class="relative h-24 rounded-md cursor-pointer">
                                                                        <!-- Avatar pequeno -->
