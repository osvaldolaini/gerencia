                    ...
                    <div role="tabpanel"
                        ...
                        <div class="grid grid-cols-2 gap-2 mb-1 sm:grid-cols-6 sm:gap-3 sm:mb-5">
                            <div class="col-span-full">
                                ...
                                @livewire('peoples.input-search', ['id' => $user_id])
                                @error('user_id')
                            ...
                            <div class="col-span-full sm:col-span-3 ">
                                ...
                                <select wire:model="role"
                                    ...
                                    @foreach (SignatureRole::cases() as $item)
                            ...
                            <div class="col-span-2 sm:col-span-3">
                                <label for="signature_password"
                                    class="block text-sm font-medium text-gray-900 dark:text-white">
                                    Senha</label>
                                <input type="password" wire:model="signature_password" placeholder="Senha" required
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
