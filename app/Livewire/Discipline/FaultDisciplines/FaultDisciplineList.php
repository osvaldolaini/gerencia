...
class FaultDisciplineList extends Component
{
    ...
    public $columnsInclude = 'fault_disciplines.number,peoples.logo_path as path,year,al_nick,fault_disciplines.student_id,al_number,al_class,fact_date,solution_date,delivered_date,justification_date,bi_date,sincomil_date,fault_disciplines.active as status';
